abstract class MovieConstants {
  ...
  static const String defaultDate = "2019-03-17";
  static const String defaultOverview = "There is no overview for this movie.";
  static const String defaultTitle = "There is no title for this movie";
}
